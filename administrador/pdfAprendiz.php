...
if(isset($_REQUEST['E'])){
   $E=$_REQUEST['E'];
  if(isset($busqueda)){
    echo "<script>window.location.href='content-type:aplication/xls'; </script>";  
   echo "<script>window.location.href='Content-Disposition: attachment; filename=busquedaAprendices.xls'; </script>";         


}else{
  echo "<script>window.location.href='content-type:aplication/xls'; </script>";  
  echo "<script>window.location.href='Content-Disposition: attachment; filename=listaAprendices.xls'; </script>";  
