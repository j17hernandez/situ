...
if(isset($_REQUEST['E'])){
  ...
  echo "<script>window.location.href='content-type:aplication/xls'; </script>";  
   echo "<script>window.location.href='Content-Disposition: attachment; filename=busquedaArea.xls'; </script>";         


}else{
  echo "<script>window.location.href='content-type:aplication/xls'; </script>";  
  echo "<script>window.location.href='Content-Disposition: attachment; filename=lista_Areas.xls'; </script>";  
