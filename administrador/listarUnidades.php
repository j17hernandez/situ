...
?>
 ...
 <a href="registrarUnidad.php" class="btn btn-success" title="Crear Unidad"><span class="icon-plus1"></span> Unidades</a>
</div>
  ...
  $sqlA= "SELECT * FROM area WHERE id_area=".$fila['id_area'];
    ...
    <td align='center' class='bg- bg-lg bg-outline col-xs-3'>
      ...
      <?php if ($tipoUsuario=='administrador') {
              ...
              ?> 
         <a class='btn btn-light' title="Activar Unidad" href='./eliminarUnidad.php?token=<?php echo $fila['token'];?>'><span class="icon-cancel text-danger" style="font-size: 25px"></span></a><?php  }else{
          ?>
