...
if( $conectarBD->query($sql)){
 ...
 <a href="registrarTurnoEspecial.php" class="btn btn-success" title="Crear Turno"><span class="icon-plus1"></span> Turnos Especiales</a>
</div>
...
?>
<div align="right" style="margin-top: -80px; margin-right: 48px; ">
