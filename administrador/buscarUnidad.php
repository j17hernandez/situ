 ...
 <?php
  ...
  $sqlA= "SELECT * FROM area WHERE id_area=".$fila['id_area'];
    ...
    <td align='center' class='bg- bg-lg bg-outline col-xs-3'>
      ...
      <a class='btn btn-secondary' href='./editarUnidad.php?token=<?php echo $fila['token'];?> ' title="Editar Unidad"><i class="icon-edit" style="font-size: 25px"></i> </a>
      <?php if ($tipoUsuario=='administrador') {
                       if ($idUser==1) {
                        if ($fila['estado']=='Inactivo') {
              ?> 
         <a class='btn btn-light' title="Eliminar Unidad" href='./eliminarUnidad.php?token=<?php echo $fila['token'];?>'><span class="icon-cancel text-danger" style="font-size: 25px"></span></a><?php  }else{
          ?>
          <a class='btn btn-light' title="Eliminar Unidad" href='./eliminarUnidad.php?token=<?php echo $fila['token'];?>'><span class="icon-checkmark1 text-success" style="font-size: 25px"></span></a>
          <?php 
         }  
              }else{
                ?>
                <a class='btn btn-danger' title="Eliminar Unidad" href='./eliminarUnidad.php?token=<?php echo $value['token'];?>'><span class="icon-bin text-light" style="font-size: 25px"></span></a>
                <?php 
              }
            }
               ?>
