...
if(isset($_REQUEST['E'])){
  ...
  if(isset($busqueda)){
   ...
   echo "<script>window.location.href='Content-Disposition: attachment; filename=busquedaTurnoR.xls'; </script>";         


}else{
  echo "<script>window.location.href='content-type:aplication/xls'; </script>";  
  echo "<script>window.location.href='Content-Disposition: attachment;filename=listaTurnosR.xls'; </script>";  
